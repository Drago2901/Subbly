...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-[#0c0b08] text-[#f4f3ef] font-sans antialiased bg-grid-white-pattern selection:bg-[#ff5c3a]/30 selection:text-[#ff8c73]">
      ...
      <section className="relative px-6 pt-20 pb-16 md:px-12 md:pt-28 md:pb-24 overflow-hidden">
        {/* Glow Spheres */}
        <div className="pointer-events-none absolute -top-40 left-1/2 -translate-x-1/2 h-[450px] w-[800px] rounded-full bg-gradient-to-b from-[#ff5c3a]/12 to-transparent blur-[120px] z-0" />
        ...
        <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-start text-left">
            {/* Badge Indicator */}
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-orange-500/20 bg-orange-950/20 px-3.5 py-1 text-xs font-semibold tracking-wide text-[#ff7558]">
              <Sparkles className="h-3.5 w-3.5 text-[#ff5c3a]" />
              <span>Next-Gen Speech-to-Text AI</span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-[56px] font-bold leading-[1.08] tracking-tight text-white mb-6 font-sans">
              Word-Perfect <br />
              <span className="bg-gradient-to-r from-[#ff5c3a] to-[#ff8c73] bg-clip-text text-transparent">AI Captions</span> <br />
              in seconds.
            </h1>

            <p className="text-base md:text-lg text-zinc-400 leading-relaxed mb-8 max-w-[460px]">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8 w-full sm:w-auto">
              ...
              <Dialog>
                <DialogTrigger asChild>
                  <button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-zinc-800 bg-zinc-900/60 hover:bg-zinc-850 px-6 py-4 text-[15px] font-semibold text-zinc-300 hover:text-white transition-all">
                    <Play className="h-4 w-4 fill-zinc-300 group-hover:fill-white" /> Watch Demo
                  </button>
                </DialogTrigger>
                <DialogContent className="max-w-[720px] border-zinc-800 bg-[#0c0b08] p-0 overflow-hidden shadow-2xl">
                  <DialogHeader className="p-4 border-b border-zinc-850 bg-zinc-950">
            ...
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2 mb-8 text-xs font-medium text-zinc-500">
            ...
            {/* Social Proof Row */}
            <div className="flex items-center gap-3.5 border-t border-zinc-800/80 pt-6 w-full">
              <div className="flex -space-x-2.5">
                {[
                  ...
                  <img
                    ...
                    src={src}
                    alt="Creator Avatar"
                    className="h-8.5 w-8.5 rounded-full border-2 border-[#0c0b08] object-cover"
                  />
                ))}
              </div>
              <div>
                <div className="flex items-center gap-0.5 text-amber-400">
                  ...
                  <span className="text-[12.5px] font-bold text-white ml-1">4.9 / 5</span>
                </div>
                <div className="text-[11.5px] text-zinc-500 font-semibold">Trusted by 50,000+ creators worldwide</div>
              </div>
            </div>
      ...
      {/* Premium Logo Cloud */}
      <section className="border-y border-zinc-900 bg-zinc-950/40 py-10 px-6">
        <div className="mx-auto max-w-7xl">
          <p className="text-center text-[10.5px] font-bold uppercase tracking-widest text-zinc-650 mb-7">SUPPORTED CREATOR PLATFORMS</p>
          <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-6 md:gap-x-20">
            {platforms.map((platform) => (
              <div 
                key={platform.name} 
                className="flex items-center gap-2 text-zinc-500 hover:text-[#ff5c3a] transition-colors duration-300 group cursor-pointer"
              >
      ...
      {/* Statistics Section */}
      <section className="py-14 px-6 bg-gradient-to-b from-[#0c0b08] to-zinc-950/20">
        <div className="mx-auto max-w-6xl grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={idx} className="text-center p-4 border-r border-zinc-900 last:border-r-0">
              <div className="text-3xl md:text-4xl font-extrabold text-white tracking-tight font-mono mb-1">
      ...
      <section id="features" className="px-6 py-20 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 group relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/30 p-7 hover:border-orange-500/30 transition-all duration-300 subbly-card-hover">
            <div className="mb-6 flex h-11 w-11 items-center justify-center rounded-xl bg-orange-950/40 border border-orange-500/20">
              <Sparkles className="h-5.5 w-5.5 text-[#ff5c3a]" />
            </div>
            <h3 className="text-lg font-bold text-white mb-2">99% Accurate AI Speech Engine</h3>
            <p className="text-xs text-zinc-400 max-w-[480px] leading-relaxed mb-6">
            ...
            <div className="h-20 w-full rounded-xl bg-zinc-950/70 border border-zinc-850 p-4 flex items-center justify-between gap-1.5 opacity-80 group-hover:opacity-100 transition-opacity">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/30 p-7 hover:border-orange-500/30 transition-all duration-300 subbly-card-hover">
            <div className="mb-6 flex h-11 w-11 items-center justify-center rounded-xl bg-orange-950/40 border border-orange-500/20">
              <Type className="h-5.5 w-5.5 text-[#ff5c3a]" />
            </div>
            <h3 className="text-lg font-bold text-white mb-2">Styled Caption Presets</h3>
            ...
            <div className="flex flex-col gap-2 rounded-xl bg-zinc-950/40 p-2.5 border border-zinc-850">
              ...
              <div className="flex items-center justify-between rounded border border-zinc-800 bg-zinc-900 px-2 py-1.5 text-[9.5px] font-sans text-white/70">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/30 p-7 hover:border-orange-500/30 transition-all duration-300 subbly-card-hover">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Tactile Timeline Slider</h3>
            <p className="text-xs text-zinc-400 leading-relaxed mb-6">
            ...
            <div className="h-14 w-full rounded-xl bg-zinc-950/50 border border-zinc-850 p-2 flex items-center">
          ...
          <div className="md:col-span-2 group relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/30 p-7 hover:border-orange-500/30 transition-all duration-300 subbly-card-hover">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Translate Into 100+ Languages</h3>
            <p className="text-xs text-zinc-400 max-w-[480px] leading-relaxed mb-6">
            ...
            <div className="flex gap-2 text-[10.5px]">
              <span className="rounded bg-orange-950/35 border border-orange-500/20 text-[#ff7558] px-2.5 py-1 font-bold">🇺🇸 English</span>
              <span className="text-zinc-650 pt-1">➜</span>
              <span className="rounded bg-zinc-950/50 border border-zinc-850 text-zinc-400 px-2.5 py-1 font-semibold">🇪🇸 Spanish</span>
              <span className="rounded bg-zinc-950/50 border border-zinc-850 text-zinc-400 px-2.5 py-1 font-semibold">🇫🇷 French</span>
              <span className="rounded bg-zinc-950/50 border border-zinc-850 text-zinc-400 px-2.5 py-1 font-semibold">🇯🇵 Japanese</span>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/30 p-7 hover:border-orange-500/30 transition-all duration-300 subbly-card-hover">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Multi-Format Exports</h3>
            <p className="text-xs text-zinc-400 leading-relaxed mb-6">
            ...
            <div className="flex items-center gap-1.5 rounded-lg bg-zinc-950/80 p-2.5 border border-zinc-850 text-[10.5px] font-mono text-zinc-450 justify-between">
              <div className="flex items-center gap-1.5">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/30 p-7 hover:border-orange-500/30 transition-all duration-300 subbly-card-hover">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Cloud Project Syncing</h3>
            <p className="text-xs text-zinc-400 leading-relaxed mb-6">
      ...
      <section className="border-t border-zinc-900 bg-zinc-950/20 py-20 px-6">
        <div className="mx-auto max-w-7xl">
          <div className="text-center max-w-xl mx-auto mb-14">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-white mt-3 mb-4">Explore the editing console</h2>
            <p className="text-sm text-zinc-400">Click the tabs below to preview the core editor features in high detail.</p>
          </div>
          ...
          <div className="mx-auto max-w-4xl rounded-2xl border border-zinc-800 bg-zinc-950 p-6 shadow-2xl transition-all duration-300">
            {showcaseTab === "transcribe" && (
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center animate-fade-in">
                <div className="md:col-span-5">
                  <h3 className="text-xl font-bold text-white mb-3">Instant transcription with 99.4% precision</h3>
                ...
                <div className="md:col-span-7 bg-zinc-900/50 rounded-xl border border-zinc-850 p-4">
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center justify-between border-b border-zinc-800 pb-2">
                      <span className="text-[10px] font-mono text-zinc-550 font-semibold">SPEECH DETECTOR WAVES</span>
                      <span className="text-[9px] bg-green-950 text-green-400 px-1.5 py-0.5 rounded font-bold">READY</span>
                    </div>
                    <div className="flex flex-col gap-2">
                      <div className="rounded bg-zinc-950 p-2.5 border border-zinc-850 flex items-center justify-between">
                        <span className="text-[11px] font-bold text-white">"Welcome to the video..."</span>
                        <span className="text-[9.5px] font-mono text-zinc-500">0:00 - 0:01</span>
                      </div>
                      <div className="rounded bg-zinc-950 p-2.5 border border-zinc-850 flex items-center justify-between">
                        <span className="text-[11px] font-bold text-[#ff5c3a]">"Subbly handles transcription..."</span>
                        <span className="text-[9.5px] font-mono text-zinc-500">0:01 - 0:03</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {showcaseTab === "styles" && (
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center animate-fade-in">
                <div className="md:col-span-5">
                  <h3 className="text-xl font-bold text-white mb-3">Viral caption styles at your disposal</h3>
                  <p className="text-xs text-zinc-400 leading-relaxed mb-4">
                ...
                <div className="md:col-span-7 bg-zinc-900/50 rounded-xl border border-zinc-850 p-5 flex flex-col gap-4">
                  <div className="text-center font-extrabold uppercase tracking-wide text-2xl text-amber-400 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] border border-dashed border-zinc-700/60 p-6 rounded-lg bg-zinc-950">
                    AMBER GLOW
                  </div>
                  <div className="grid grid-cols-3 gap-2">
                    <div className="rounded border border-zinc-800 bg-zinc-950 p-2 text-center text-[10px] font-bold text-white">TikTok Style</div>
                    <div className="rounded border border-orange-500/20 bg-orange-950/20 p-2 text-center text-[10px] font-bold text-[#ff5c3a]">Neon Glow</div>
                    <div className="rounded border border-zinc-800 bg-zinc-950 p-2 text-center text-[10px] font-bold text-white">Classic SRT</div>
                  </div>
                </div>
              </div>
            )}
            ...
            {showcaseTab === "edit" && (
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center animate-fade-in">
                <div className="md:col-span-5">
                  <h3 className="text-xl font-bold text-white mb-3">Perfect subtitle timing via timeline</h3>
                  <p className="text-xs text-zinc-400 leading-relaxed mb-4">
                ...
                <div className="md:col-span-7 bg-zinc-900/50 rounded-xl border border-zinc-850 p-5 flex flex-col gap-3">
                  <div className="h-10 w-full rounded bg-zinc-950 border border-zinc-800 relative flex items-center px-3">
                    <div className="h-6 w-24 bg-orange-950/40 border border-orange-500/30 rounded text-[9.5px] font-mono text-[#ff5c3a] flex items-center justify-center">
                      [ Grab Handle ]
                    </div>
                    <div className="absolute left-28 top-0 bottom-0 w-[2px] bg-[#ff5c3a]" />
                  </div>
                  <div className="text-right text-[10px] text-zinc-500 font-mono">Drag block boundaries to sync audio layers</div>
                </div>
              </div>
            )}
            ...
            {showcaseTab === "translate" && (
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center animate-fade-in">
                <div className="md:col-span-5">
                  <h3 className="text-xl font-bold text-white mb-3">Auto-translate into multiple languages</h3>
                  <p className="text-xs text-zinc-400 leading-relaxed mb-4">
                ...
                <div className="md:col-span-7 bg-zinc-900/50 rounded-xl border border-zinc-850 p-5 flex flex-col gap-3">
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-zinc-400">English Caption:</span>
                    <span className="font-semibold text-white">"We build world-class interfaces"</span>
                  </div>
                  <div className="h-px bg-zinc-800 my-1" />
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-zinc-400">Spanish Translation:</span>
            ...
            {showcaseTab === "export" && (
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center animate-fade-in">
                <div className="md:col-span-5">
                  <h3 className="text-xl font-bold text-white mb-3">Multi-format high-speed output</h3>
                  <p className="text-xs text-zinc-400 leading-relaxed mb-4">
                ...
                <div className="md:col-span-7 bg-zinc-900/50 rounded-xl border border-zinc-850 p-5 flex flex-col gap-4">
                  <div className="flex flex-col gap-2.5">
                    <div className="flex items-center justify-between text-xs">
                      <span className="text-zinc-400">Render Progress:</span>
      ...
      <section id="how" className="px-6 py-20 md:px-12 max-w-7xl mx-auto">
        <div className="text-center max-w-xl mx-auto mb-16">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-white mt-3 mb-4">Captions in three simple steps</h2>
          <p className="text-sm text-zinc-400">Subbly streamlines transcription so you can focus entirely on video creation.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          
          {/* Vertical connecting line for layouts */}
          <div className="hidden md:block absolute top-14 left-[15%] right-[15%] h-[1.5px] bg-gradient-to-r from-[#ff5c3a] via-zinc-800 to-zinc-900 z-0" />
          ...
          {[
            ...
            <div key={idx} className="relative z-10 rounded-2xl border border-zinc-900 bg-zinc-950 p-7 group hover:border-orange-500/30 transition-all duration-300">
      ...
      <section className="border-t border-zinc-900 bg-zinc-950/45 py-20 px-6">
        <div className="mx-auto max-w-6xl">
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="text-[11px] font-bold uppercase tracking-widest text-[#ff5c3a]">COMPARISON</span>
            <h2 className="text-3xl font-bold tracking-tight text-white mt-3 mb-4">Engineered to save hours</h2>
            <p className="text-sm text-zinc-400">How Subbly stacks up against traditional subtitling workflows.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            
            {/* Without Subbly */}
            <div className="rounded-2xl border border-zinc-900 bg-zinc-950 p-8 flex flex-col justify-between opacity-80">
              <div>
                <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-550 block mb-2">WITHOUT SUBBLY</span>
                ...
                <ul className="flex flex-col gap-4 text-xs text-zinc-500">
              ...
              <div className="mt-8 border-t border-zinc-900 pt-6 text-[11px] text-zinc-600 font-semibold uppercase">Est. Time: 2-3 hours per video</div>
            </div>

            {/* With Subbly */}
            <div className="rounded-2xl border border-orange-500/20 bg-orange-950/10 p-8 flex flex-col justify-between relative shadow-orange-glow">
      ...
      <section className="px-6 py-20 md:px-12 max-w-7xl mx-auto">
        <div className="text-center max-w-xl mx-auto mb-16">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-white mt-3 mb-4">Loved by 12,000+ content creators</h2>
          <p className="text-sm text-zinc-400">See how creators and marketing teams save hours of editing time every week.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="rounded-2xl border border-zinc-900 bg-zinc-950 p-6 flex flex-col justify-between hover:border-orange-500/25 transition-all duration-300">
              <div>
                ...
                <p className="text-xs text-zinc-300 italic leading-relaxed mb-6">"{t.quote}"</p>
              </div>
              <div className="flex items-center gap-3">
                <img src={t.avatar} alt={t.name} className="h-9 w-9 rounded-full object-cover border border-zinc-800" />
                <div>
                  <div className="text-xs font-bold text-white">{t.name}</div>
                  <div className="text-[10px] text-zinc-500 font-semibold">{t.role} · {t.handle}</div>
                </div>
              </div>
            </div>
          ))}
      ...
      {/* Pricing Grid */}
      <section id="pricing" className="border-t border-zinc-900 bg-zinc-950/20 py-20 px-6 md:px-12">
        <div className="mx-auto max-w-7xl">
          <div className="text-center max-w-xl mx-auto mb-12">
            <span className="text-[11px] font-bold uppercase tracking-widest text-[#ff5c3a]">PRICING PLANS</span>
            <h2 className="text-3xl font-bold tracking-tight text-white mt-3 mb-4">Pricing that scales with your reach</h2>
            <p className="text-sm text-zinc-400">Start free and upgrade when your pipeline grows. Cancel at any time.</p>

            {/* Toggle switch */}
            <div className="mt-8 inline-flex items-center gap-1 rounded-xl bg-zinc-900 p-1 border border-zinc-800">
              <button
              ...
              >
                Yearly billing
                <span className="rounded bg-black/30 px-1.5 py-0.5 text-[9px] text-[#ff8c73] font-bold">12% OFF</span>
              </button>
            </div>
          </div>
              ...
              return (
                <div
                  ...
                  className={`relative flex flex-col rounded-2xl p-6 transition-all duration-300 ${
                    featured
                      ? "border-2 border-[#ff5c3a] bg-orange-950/10 shadow-orange-glow hover:-translate-y-1"
                      : "border border-zinc-900 bg-zinc-950 hover:border-zinc-800 hover:-translate-y-1"
                  }`}
                >
                  {featured && (
          ...
          <div className="mt-14 max-w-md mx-auto text-center rounded-2xl bg-zinc-950 p-4 border border-zinc-900 flex items-center justify-center gap-3">
            <ShieldCheck className="h-8 w-8 text-[#ff5c3a]" />
            <div className="text-left">
              <h4 className="text-xs font-bold text-white">100% Secure Checkout & UPI Autopay</h4>
              <p className="text-[10px] text-zinc-500 font-medium mt-0.5">Upgrade or downgrade dynamically. No cancellation fees.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            return (
              <div key={idx} className="py-1">
                ...
                >
                  ...
                  <ChevronDown className={`h-4 w-4 text-zinc-550 transition-transform duration-300 ${isOpen ? "rotate-180 text-[#ff5c3a]" : ""}`} />
                </button>
                <div 
                ...
                >
                  <div className="overflow-hidden text-xs text-zinc-400 leading-relaxed max-w-[680px]">
                    {faq.a}
                  </div>
                </div>
              </div>
      ...
      {/* CTA Banner Banner */}
      <section className="relative mx-4 mb-20 overflow-hidden rounded-[24px] border border-zinc-900 bg-zinc-950/80 p-8 text-center md:mx-12 md:p-16 max-w-6xl lg:mx-auto">
        <div
        ...
        <h2 className="relative z-10 text-3xl md:text-4xl font-bold tracking-tight text-white mb-4">
          Start captioning your videos for free
        </h2>
        <p className="relative z-10 text-xs text-zinc-450 mb-8 max-w-sm mx-auto">
      ...
      {/* Premium Footer */}
      <footer className="border-t border-zinc-900 bg-zinc-950/60 px-6 py-14 md:px-12 text-xs">
        <div className="mx-auto max-w-7xl grid grid-cols-2 md:grid-cols-6 gap-8 mb-10">
          ...
          <div className="col-span-2 flex flex-col items-start gap-4">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-serif text-[16.5px] font-bold text-white">Subbly</span>
            </Link>
            <p className="text-[11.5px] text-zinc-500 leading-relaxed max-w-[200px]">
              AI-powered captions for creators, agencies, and marketing editors. Ready in seconds.
            </p>
            <span className="text-[10px] text-zinc-700 font-semibold uppercase tracking-wider">© 2026 Subbly Inc.</span>
          </div>

          {/* Links Column 1: Product */}
          <div>
            <h5 className="font-bold text-white uppercase tracking-wider text-[10px] mb-4">Product</h5>
            <ul className="flex flex-col gap-3 font-medium text-zinc-450">
          ...
          <div>
            <h5 className="font-bold text-white uppercase tracking-wider text-[10px] mb-4">Resources</h5>
            <ul className="flex flex-col gap-3 font-medium text-zinc-450">
          ...
          <div>
            <h5 className="font-bold text-white uppercase tracking-wider text-[10px] mb-4">Legal</h5>
            <ul className="flex flex-col gap-3 font-medium text-zinc-450">
          ...
          {/* Newsletter / Contact Signup Column */}
          <div className="col-span-2 md:col-span-1">
            <h5 className="font-bold text-white uppercase tracking-wider text-[10px] mb-4">Get Updates</h5>
            <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-2">
              <input
                type="email"
                placeholder="Enter email..."
                className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-[#ff5c3a] transition-colors text-xs"
              />
        ...
        <div className="mx-auto max-w-7xl pt-8 border-t border-zinc-900/60 flex flex-col md:flex-row justify-between items-center gap-4 text-zinc-600 font-medium">
