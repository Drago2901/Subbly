    ...
    <div className="min-h-screen bg-[#f5f3ee] dark:bg-zinc-950 text-[#1a1a1a] dark:text-zinc-100 transition-colors duration-300" style={{ fontFamily: "'Outfit', sans-serif" }}>
      ...
      <main className="mx-auto w-full max-w-[800px] px-6 py-12 md:py-20">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none text-[15px] leading-[1.8] text-[#333] dark:text-zinc-300 space-y-6">
          <section>
            <h2 className="text-[20px] font-semibold text-[#1a1a1a] dark:text-zinc-100 mt-8 mb-3">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="text-[20px] font-semibold text-[#1a1a1a] dark:text-zinc-100 mt-8 mb-3">2. How We Process Your Media</h2>
            <p>
          ...
          <section>
            <h2 className="text-[20px] font-semibold text-[#1a1a1a] dark:text-zinc-100 mt-8 mb-3">3. Cookies and Storage</h2>
            <p>
          ...
          <section>
            <h2 className="text-[20px] font-semibold text-[#1a1a1a] dark:text-zinc-100 mt-8 mb-3">4. Information Sharing & Third Parties</h2>
            <p>
          ...
          <section>
            <h2 className="text-[20px] font-semibold text-[#1a1a1a] dark:text-zinc-100 mt-8 mb-3">5. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-[20px] font-semibold text-[#1a1a1a] dark:text-zinc-100 mt-8 mb-3">6. Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-[20px] font-semibold text-[#1a1a1a] dark:text-zinc-100 mt-8 mb-3">7. Contact Us</h2>
            <p>
